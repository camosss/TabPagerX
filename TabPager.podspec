Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                    ...
                    DESC
  spec.homepage     = "https://github.com/camosss/TabPager"
  spec.license      = { :type => "MIT", :file => "LICENSE" }
  spec.author       = { "HoSung Kang" => "camosss777@gmail.com" }
  spec.platform     = :ios, "15.0"
  spec.source       = { :git => "https://github.com/camosss/TabPager.git", :tag => spec.version.to_s }
  spec.swift_version = "5.0"
  spec.source_files  = "Sources/TabPager/**/*.{swift}"
