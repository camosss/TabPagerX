...
//  just with different data. This is the "hello world" of TabPager.
//
...
struct SameContentSample: View {
    ...
    //    selection and per-tab state. A stable id is what lets TabPager keep
    ...
    // are present, TabPager selects the first one automatically. You can read
